...
export const walkthroughClassB = [
  {
    ...
    steps: [
      {
        ...
        script: "Steering box is securely mounted and not leaking. Hoses are not cracked or leaking.",
      },
      {
    ...
    steps: [
      {
        ...
        script: "Springs and shock absorbers not cracked or leaking. Mounts are secure.",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        script: "With brakes released and pulled by hand, pushrod should not move more than 1 inch.",
        mustSay: true,
        required: true,
      },
      {
    ...
    steps: [
      {
        ...
        script: "Tire tread evenly worn, at least 4/32” on steer tires, with no cuts or bulges.",
        mustSay: true,
        required: true,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        label: "Catwalk/Steps",
        script: "Catwalk and steps solid, clear of objects, and securely mounted.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      {
        label: "Reflectors",
        script: "All reflectors and clearance lights are correct color, clean, and not broken.",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        script: "Lift or hoist operates correctly, no missing or damaged parts.",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        label: "Gauges",
        script: "Check oil pressure, coolant temperature, and voltmeter for normal readings.",
      },
      {
