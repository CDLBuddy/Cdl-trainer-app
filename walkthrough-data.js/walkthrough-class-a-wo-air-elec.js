  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        script:
          'License plate light is clean, working, and the plate is secure.',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        script:
          'I would check that the mounting bolts are secure and not missing.',
      },
      {
        label: 'Fifth Wheel',
        script:
      ...
      },
      {
        label: 'Release Arm',
        script:
          'I would check that the release arm is secure and in the locked position.',
      },
      {
        label: 'Skid Plate',
        script:
          'The skid plate should not be cracked, broken, or excessively worn.',
      },
      {
      ...
      },
      {
        ...
        script:
          'The frame and crossmembers should not be cracked, broken, or missing.',
      },
      {
        label: 'Floor',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        label: 'Gauges',
        script:
          'I would check all gauges—oil pressure, coolant temperature, voltmeter—for normal readings.',
      },
      {
