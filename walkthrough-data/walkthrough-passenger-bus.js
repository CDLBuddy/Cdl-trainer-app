    ...
    steps: [
      {
        label: 'Oil Level',
        script:
          'Check engine oil level using the dipstick; oil must be within safe operating range.',
        mustSay: true,
        required: true,
      },
      {
        label: 'Coolant Level',
        script:
          'Ensure coolant is at proper level in reservoir and cap is secure.',
        mustSay: true,
        required: true,
      },
      {
      ...
      },
      {
        label: 'Leaks & Hoses',
        script:
          'Look for leaks or puddles under engine; inspect all hoses for leaks and cracks.',
        mustSay: true,
      },
      {
        label: 'Belts',
    ...
    steps: [
      {
        ...
        script:
          'Ensure steering box is securely mounted, not leaking, and hoses have no leaks.',
      },
      {
        label: 'Steering Linkage',
        script:
          'No worn, cracked, or loose components in the steering linkage.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        script:
          'Springs and shocks not missing, broken, or leaking. Mounts are secure.',
      },
      {
        label: 'Spring Mounts/U-Bolts',
        script:
          'Check spring mounts and U-bolts for cracks, breaks, or looseness.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        script:
          'Tread is evenly worn, at least 4/32” on steer tires, no cuts or bulges.',
        mustSay: true,
        required: true,
      },
      {
    ...
    steps: [
      {
        label: 'Entry Door',
        script:
          'Entry door opens and closes properly, glass clean and not cracked.',
        mustSay: true,
        required: true,
      },
      {
      ...
      },
      {
        label: 'Mirrors',
        script:
          'All exterior mirrors are securely mounted, clean, and properly adjusted.',
      },
      {
      ...
      },
      {
        ...
        script:
          'Reflectors and clearance lights are clean, correct color, and working.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        script:
          'Fire extinguisher, first aid kit, and emergency reflectors are present and secure.',
        mustSay: true,
        required: true,
      },
      {
        ...
        script:
          'Check all emergency exits (windows, roof hatches, rear door) for proper function and labeling.',
        mustSay: true,
        required: true,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        label: 'Safe Start',
        script:
          'Before starting: parking brake applied, gearshift in neutral or park, clutch depressed if manual.',
        mustSay: true,
        required: true,
      },
      {
        label: 'Gauges',
        script:
          'Check oil pressure, coolant temperature, air pressure, and voltmeter for normal readings.',
      },
      {
