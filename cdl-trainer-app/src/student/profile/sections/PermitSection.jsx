  ...
  return (
    <section id="permit" className={styles.section} aria-labelledby={titleId}>
      ...
      <div id={hintId} className={styles.sub}>
        Required before Behind-the-Wheel • If you already have a permit, upload
        a clear photo and set the expiry date.
      </div>
        ...
        <div className={styles.grid}>
          <div className={styles.fieldGroup}>
            ...
            <p className={styles.subtle} style={{ marginTop: 6 }}>
              Accepted formats: JPG/PNG/WebP • Max 8&nbsp;MB. Make sure your
              name, number, and dates are readable.
            </p>
          </div>
        </div>
      )}
