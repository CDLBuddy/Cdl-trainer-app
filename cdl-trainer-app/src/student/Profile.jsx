  ...
  if (p.status && p.status !== 'active') {
    return (
      ...
      >
        ...
        <p>
          Your profile is currently inactive. Please contact your instructor or
          school admin.
        </p>
        <button
  ...
  return (
    ...
    >
      ...
      <div className="progress-bar" style={{ marginBottom: '1.2rem' }}>
        <div
          className="progress"
          style={{ width: `${progress}%`, background: brand?.primaryColor }}
        />
      ...
      >
        ...
        <label>
          ...
          {p.profilePicUrl ? (
            <img
              src={p.profilePicUrl}
              alt="Profile"
              style={{ maxWidth: 80, marginTop: 6, borderRadius: 9 }}
            />
          ) : null}
        </label>
        ...
        <label>
          ...
          >
            ...
            <option value="A-WO-HYD-ELEC">
              Class A w/o Hydraulic/Electric
            </option>
          ...
          {endorsementOptions.map(opt => (
            <label key={opt.val} style={{ marginRight: '1em' }}>
              <input
                type="checkbox"
                checked={
                  Array.isArray(p.endorsements) &&
                  p.endorsements.includes(opt.val)
                }
            ...
            <label key={opt.val} style={{ marginRight: '1em' }}>
              <input
                ...
                checked={
                  ...
                  p.restrictions.includes(opt.val)
                }
        ...
        {p.cdlPermit === 'yes' && (
          <>
            <label>
              ...
              {p.permitPhotoUrl ? (
                <img
                  src={p.permitPhotoUrl}
                  alt="Permit"
                  style={{ maxWidth: 90, marginTop: 6, borderRadius: 8 }}
                />
              ) : null}
            </label>
        ...
        <label>
          ...
          <input
            ...
            accept="image/*"
            onChange={e =>
              handleUpload(e.target.files?.[0], 'licenses', 'driverLicenseUrl')
            }
          />
          {p.driverLicenseUrl ? (
            <img
              src={p.driverLicenseUrl}
              alt="License"
              style={{ maxWidth: 90, marginTop: 6, borderRadius: 8 }}
            />
          ) : null}
        ...
        <label>
          ...
          <input
            ...
            accept="image/*"
            onChange={e =>
              handleUpload(e.target.files?.[0], 'medCards', 'medicalCardUrl')
            }
          />
          {p.medicalCardUrl ? (
            <img
              src={p.medicalCardUrl}
              alt="Medical Card"
              style={{ maxWidth: 90, marginTop: 6, borderRadius: 8 }}
            />
          ) : null}
        ...
        <label>
          ...
          <input
            ...
            accept="image/*"
            onChange={e =>
              handleUpload(e.target.files?.[0], 'payments', 'paymentProofUrl')
            }
          />
          {p.paymentProofUrl ? (
            <img
