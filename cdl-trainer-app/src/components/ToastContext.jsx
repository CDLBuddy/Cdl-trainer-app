...
export default function Shell({
  ...
  /* ------------------------ Toast Bridge (React) ---------------------- */
  // Your ToastProvider exposes { showToast, success, error, info, warning, close, clear }
    ...
    const handler =
      toastApi
        ? (msg, opts = {}) => {
            ...
            toastApi.showToast?.(msg, { duration, type });
          }
        : null;

    // Register with ui-helpers; it will fall back to DOM toasts if null
    ...
    <div className={styles.root}>
      ...
      {showFooter && (
        <footer className={styles.footer} role="contentinfo">
          <div>© {currentYear} CDL Trainer • Powered by CDL Buddy</div>
