  ...
  if (currentRole !== 'admin') {
    return (
      <div
        ...
        style={{ margin: '2em auto', maxWidth: 440 }}
      >
        <h3>Access Denied</h3>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td
                    colSpan={11}
                    style={{ textAlign: 'center', color: '#789' }}
                  >
                    No users found.
                  </td>
                </tr>
                    ...
                    <tr key={user.id || user.email}>
                      ...
                      <td>
                        <input
                          ...
                          onChange={e =>
                            handleCompanyChange(user, e.target.value)
                          }
                          placeholder="(Company)"
                          style={{ width: 120 }}
                        />
                      ...
                      <td>
                        <select
                          ...
                          onChange={e =>
                            handleInstructorChange(user, e.target.value)
                          }
                        >
