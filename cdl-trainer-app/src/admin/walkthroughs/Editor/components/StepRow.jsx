    ...
    <div className={cls.step}>
      ...
      <div className={cls.checks}>
        <label>
          <input
            type="checkbox"
            checked={!!step.mustSay}
            onChange={() => onToggle(si, ti, 'mustSay')}
          />{' '}
          mustSay
        </label>
        <label>
          <input
            ...
            onChange={() => onToggle(si, ti, 'required')}
          />{' '}
          required
        </label>
        <label>
          <input
            type="checkbox"
            checked={!!step.passFail}
            onChange={() => onToggle(si, ti, 'passFail')}
          />{' '}
          passFail
        </label>
        <label>
