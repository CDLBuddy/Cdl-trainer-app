    ...
    >
      ...
      {view !== 'list' ? (
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button type="button" onClick={() => onCreate('A')} style={primary}>
            + New (Class A)
          </button>
          <button type="button" onClick={() => onCreate('B')} style={base}>
            + New (Class B)
          </button>
          <button
            type="button"
            onClick={() => onCreate('PASSENGER-BUS')}
            style={base}
          >
            + New (Passenger Bus)
          </button>
          <button type="button" onClick={onImport} style={base}>
            Import (MD/CSV/XLSX)
          </button>
        </div>
      )}
