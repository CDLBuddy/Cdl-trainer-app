  ...
  return (
    <div className={cls.card}>
      ...
      <textarea
        ...
        placeholder={
          '{"label":"Class A – School","classCode":"A","version":1,"sections":[{"section":"Engine Compartment","steps":[{"label":"Oil Level","script":"Check dipstick…"}]}]}'
        }
      />
      <div className={cls.toolbar}>
        <button type="button" className={cls.btn} onClick={onParse}>
          Parse JSON
        </button>
      </div>
    </div>
