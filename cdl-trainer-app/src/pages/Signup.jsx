...
import { auth, db } from "../utils/firebase"; // Adjust your import paths!
...
import { getBlankUserProfile } from "../utils/user-profile";
...
function Signup() {
  ...
  // Render
  return (
    <div className="signup-card fade-in" style={{ maxWidth: 480, margin: "34px auto" }}>
      <h2 style={{ textAlign: "center" }}>
        {brandLogo && <img src={brandLogo} style={{ height: 38, maxWidth: 96, verticalAlign: "middle", marginBottom: "0.15em", borderRadius: 8 }} alt="School Logo" />}
          ...
          <div style={{ position: "relative" }}>
            ...
            <button
              ...
              style={{
                ...
                background: "none", border: "none", color: "var(--accent)", fontSize: "1.14em", cursor: "pointer"
              }}
              onClick={togglePwd}
              tabIndex={0}
            >
