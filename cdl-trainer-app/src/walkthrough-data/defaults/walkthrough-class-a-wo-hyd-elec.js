// src/walkthrough-data/defaults/walkthrough-class-a-wo-hyd-elec.js
// =============================================================================
...
const walkthroughClassAWoHydElec = {
  id: 'walkthrough-class-a-wo-hyd-elec',
  classCode: 'A-WO-HYD-ELEC',
  label: 'Class A (w/o Hydraulic/Electric Lines)',
  version: 1,
  ...
  sections: [
    ...
    /* -------------------------------- Brakes F -------------------------------- */
    {
      ...
      critical: true,
      steps: [
        { label: 'Brake Hoses/Lines', script: 'I would inspect hoses and lines for leaks, cracks, or wear.' },
        { label: 'Brake Chamber', script: 'I would check that the brake chamber is securely mounted and not leaking.' },
        {
    ...
    /* ---------------------------- Front Wheel/Tire ---------------------------- */
    {
      ...
      steps: [
        ...
        { label: 'Valve Stem', script: 'The valve stem and cap should not be missing, broken, or leaking.' },
      ],
    },
    ...
    /* ----------------------------- Driver/Fuel Area --------------------------- */
    {
      ...
      steps: [
        { label: 'Door & Hinges', script: 'I would check that the door opens and closes properly, hinges are secure, and the seal is intact.' },
        { label: 'Mirror Brackets', script: 'I would check that the mirror brackets are securely mounted and not damaged.' },
        { label: 'Fuel Tank/Cap/Leaks', script: 'I would check that the fuel tank is secure, not leaking, and the cap is tight.' },
        { label: 'Battery/Box', script: 'I would check that the battery/box is secure, connections are tight, and there is no corrosion.' },
        { label: 'Catwalk/Steps', script: 'I would check that the catwalk and steps are solid, clear of objects, and securely bolted.' },
      ],
    },
    ...
    /* ----------------------- Rear Axle / Trailer Suspension ------------------- */
    {
      ...
      steps: [
        { label: 'Springs/Shocks', script: 'I would check that the springs and shocks are not missing, broken, or leaking, and the mounts are secure.' },
        { label: 'Torque Arm', script: 'I would check the torque arm for cracks or breaks and that it’s securely mounted.' },
        { label: 'Air Bags (Skip)', script: 'This truck/trailer does not have air ride suspension.', skip: true },
      ],
    },
    ...
    /* -------------------------------- Brakes R -------------------------------- */
    {
      ...
      critical: true,
      steps: [
        { label: 'Brake Hoses/Lines', script: 'I would check hoses and lines for leaks, cracks, or wear.' },
        { label: 'Brake Chamber', script: 'I would check that the brake chamber is securely mounted and not leaking.' },
        {
          label: 'Slack Adjuster/Pushrod',
          script:
    ...
    /* ---------------------------- Lights / Reflectors ------------------------- */
    {
      ...
      steps: [
        { label: 'Reflectors', script: 'I would check all reflectors and clearance lights for proper color and that they are clean and not broken.' },
        { label: 'Tail, Turn, Brake Lights', script: 'I would check that all tail, turn signal, brake, and marker lights are the correct color and working.' },
        { label: 'License Plate Light', script: 'License plate light is clean, working, and the plate is secure.' },
      ],
    },

    /* ----------------- Trailer / Coupling (no hydraulic/electric) ------------- */
    {
      ...
      steps: [
        ...
        { label: 'Fifth Wheel', script: 'The fifth wheel should be properly greased, securely mounted, and not cracked or broken.' },
        ...
        { label: 'Trailer Front/Rear', script: 'Check trailer front and rear for damage, all lights, reflectors, and DOT tape.' },
    ...
    /* --------------------- In-Cab / Safe Start / Controls -------------------- */
    {
      ...
      steps: [
        ...
        { label: 'Gauges', script: 'I would check all gauges—oil pressure, coolant temperature, voltmeter—for normal readings.' },
